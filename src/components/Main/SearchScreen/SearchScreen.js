...
const SearchScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <SearchBar setResult={setResult} value={result.searchValue} />
      {result.searchValue === "" ? (
        ...
        <Tab.Navigator>
          ...
          <Tab.Screen
            ...
            children={() => (
              <ListCourse navigation={navigation} courses={result.courses} />
            )}
          />
          <Tab.Screen
            name={languageConstant.AUTHOR}
            children={() => (
              <ListAuthors navigation={navigation} authors={result.authors} />
            )}
          />
        </Tab.Navigator>
      )}
