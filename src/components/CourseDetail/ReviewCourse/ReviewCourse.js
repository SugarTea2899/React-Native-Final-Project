  ...
  return (
    <>
      <View style={styles.container}>
        <Text
          style={{
            color: theme.TEXT_COLOR_BLUR,
            fontSize: 35,
            fontWeight: "bold",
            marginTop: 5,
          }}
        >{`(${course.averagePoint})`}</Text>
        <View style={styles.reviewContainer}>
          ...
          <Stars
            ...
            maxStar={5}
            curStar={
              course.formalityPoint > 5 ? 5 : Math.round(course.formalityPoint)
            }
            starSize={30}
          />
        </View>
        <View style={styles.reviewContainer}>
          ...
          <Stars
            ...
            maxStar={5}
            curStar={
              course.contentPoint > 5 ? 5 : Math.round(course.contentPoint)
            }
            starSize={30}
          />
        </View>
        <View style={styles.reviewContainer}>
          ...
          <Stars
            ...
            starSize={30}
            curStar={
              course.presentationPoint > 5
                ? 5
                : Math.round(course.presentationPoint)
            }
          />
        </View>
        <MyButton
        ...
        />
        {getReviews().map((item) => (
          <Review key={item.id} style={{ marginBottom: 15 }} review={item} />
        ))}
      </View>
    </>
  );
